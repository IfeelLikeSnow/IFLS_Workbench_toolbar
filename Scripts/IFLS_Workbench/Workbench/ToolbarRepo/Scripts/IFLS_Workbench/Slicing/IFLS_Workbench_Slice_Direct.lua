-- @description IFLS Workbench - Workbench/ToolbarRepo/Scripts/IFLS_Workbench/Slicing/IFLS_Workbench_Slice_Direct.lua
-- @version 0.63.0
...
local function main()
  ...
  r.Undo_EndBlock("IFLS Workbench: Slice Direct", -1)
  r.UpdateArrange()
end
