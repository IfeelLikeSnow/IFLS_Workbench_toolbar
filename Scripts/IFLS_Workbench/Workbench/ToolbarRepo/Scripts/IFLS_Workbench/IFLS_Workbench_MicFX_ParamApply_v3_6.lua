-- @description IFLS Workbench - Workbench/ToolbarRepo/Scripts/IFLS_Workbench/IFLS_Workbench_MicFX_ParamApply_v3_6.lua
-- @version 0.63.0
...
r.Undo_EndBlock("DF95 IFLS Workbench - MicFX ParamApply v3.6 (LiveAware)", -1)
r.UpdateArrange()
