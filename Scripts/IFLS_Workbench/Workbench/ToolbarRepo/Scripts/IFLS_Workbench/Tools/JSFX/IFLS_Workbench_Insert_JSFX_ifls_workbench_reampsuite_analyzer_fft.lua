-- @description IFLS Workbench - Workbench/ToolbarRepo/Scripts/IFLS_Workbench/Tools/JSFX/IFLS_Workbench_Insert_JSFX_ifls_workbench_reampsuite_analyzer_fft.lua
-- @version 0.63.0
...
-- @version 0.7.8
-- @author IFLS
-- @about Inserts the JSFX "IFLS Workbench - ReampSuite Analyzer FFT" onto all selected tracks (or last touched track).
...
local fxname = 'IFLS Workbench - ReampSuite Analyzer FFT'
