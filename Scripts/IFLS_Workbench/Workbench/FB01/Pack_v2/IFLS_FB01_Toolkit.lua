-- @description IFLS Workbench - FB-01 Pack Redirect (Pack_v2)
-- @version 0.78.0
-- @author IfeelLikeSnow
--
-- This pack was archived to: Workbench/FB01/Archive/Pack_v2/
...
local target = wb_root().."/Workbench/FB01/Archive/Pack_v2/IFLS_FB01_Toolkit.lua"
