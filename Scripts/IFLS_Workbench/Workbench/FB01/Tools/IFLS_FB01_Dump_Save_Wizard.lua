...
local Syx = dofile(wb_root.."/Workbench/FB01/Core/ifls_fb01_sysex.lua")
...
local function export_selected_item_to_syx(path)
  ...
  local exporter = wb_root.."/Workbench/FB01/Pack_v8/Scripts/IFLS_FB01_Export_SelectedItem_SysEx_To_SYX.lua"
