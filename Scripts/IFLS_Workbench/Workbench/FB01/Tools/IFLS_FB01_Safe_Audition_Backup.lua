...
local function send_file(path)
  ...
  dofile(root.."/Workbench/FB01/Pack_v8/Scripts/IFLS_FB01_Replay_SYX_File_FromPath.lua")
end
...
local backup_path = r.GetResourcePath().."/Scripts/IFLS_Workbench/Docs/Reports/FB01_AuditionBackup_"..ts..".syx"
