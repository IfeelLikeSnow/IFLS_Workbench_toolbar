-- @description IFLS Workbench - Tools/JSFX/IFLS_Workbench_Insert_JSFX_ifls_workbench_drone_granular_texture.lua
-- @version 0.63.0
-- @author IfeelLikeSnow

-- @description IFLS Workbench: Insert JSFX - IFLS Workbench - Drone Granular Texture
-- @version 0.7.8
-- @author IFLS
...
local fxname = 'IFLS Workbench - Drone Granular Texture'
...
return SafeApply.run("IFLS: IFLS Workbench Insert JSFX ifls workbench drone granular texture", function()
