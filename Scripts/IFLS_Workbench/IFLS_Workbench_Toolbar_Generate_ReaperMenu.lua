...
local entries = {
  {"Explode Fieldrec + MicFX + Buses", "Scripts/IFLS_Workbench/IFLS_Workbench_Explode_Fieldrec.lua"},
  {"PolyWAV Toolbox (ImGui)",          "Scripts/IFLS_Workbench/IFLS_Workbench_PolyWAV_Toolbox.lua"},
  {"Slice Smart (print bus -> slice)", "Scripts/IFLS_Workbench/Slicing/IFLS_Workbench_Slice_Smart_PrintBus_Then_Slice.lua"},
  {"Slicing dropdown menu",            "Scripts/IFLS_Workbench/Slicing/IFLS_Workbench_Menu_Slicing_Dropdown.lua"},
  {"Install helpers (register scripts)", "Scripts/IFLS_Workbench/IFLS_Workbench_Install_Toolbar.lua"},
  {"Diagnostics",                      "Scripts/IFLS/IFLS_Diagnostics.lua"},
  {"Cleanup duplicates",               "Scripts/IFLS/IFLS_Cleanup_Duplicate_IFLS_Scripts.lua"},
}
...
for i, e in ipairs(entries) do
  ...
  if cmd and cmd ~= 0 then
    table.insert(lines, "icon_"..id.."=text")
